...
<body>
	...
	<h4 style="text-align: center; padding-top: 40px;">Create New
		Company</h4>
	<form:form method="POST" action="/stockInsert" modelAttribute="stock">
		<table align="center">
			<%-- <tr>
				<td>StockExchange ID</td>
				<td><form:input type="text" path="stockexchangeId" /> <form:errors
						path="stockexchangeId" cssClass="error"></form:errors></td>
			</tr> --%>
			<tr>
				<td>StockExchange Name</td>
				<td><form:input type="text" path="stockexchangeName" /> <form:errors
						path="stockexchangeName" cssClass="error"></form:errors></td>
			</tr>
			<tr>
				<td>Brief</td>
			...
			<tr>
				...
				<td><form:input type="text" path="contactAddress" /> <form:errors
						path="contactAddress" cssClass="error"></form:errors></td>
			</tr>
			<tr>
				<td>Remarks</td>
